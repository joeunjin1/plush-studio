-- STAGING READ-ONLY UAT VERIFICATION (single result set).
-- Excludes personalisation text, buyer email, contact details, image object keys,
-- URLs, and binary data so it can be safely captured in the SQL Editor.
