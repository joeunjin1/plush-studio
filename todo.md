...
- [ ] Redesign the protected Catalog Admin from a sparse intake form into a premium product-operations workspace: compact command header, product evidence/status rail, focused task stages, and clear draft/review/publication decisions without changing authorization or data contracts.
