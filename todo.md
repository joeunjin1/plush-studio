...
- [ ] Separate generic 3D-maker request controls from the official reference-product order context, and provide an unambiguous buyer confirmation and re-entry path after a reference order is received.
